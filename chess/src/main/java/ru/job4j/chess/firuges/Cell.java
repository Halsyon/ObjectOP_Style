...
public enum Cell { // этот класс описывает все клетки на шахматной доске.
    ...
    public static Cell findBy(int x, int y) { //чтобы получить нужный объект из перечисления мы используем статический метод.
        Cell rsl = null;
